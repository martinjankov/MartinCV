                    ...
                    <div className="row">
                        <div className="col-xs-12">
                            ...
                            <div>
                                ...
                                <a href="https://app.codeable.io/tasks/new?preferredContractor=55410"  rel="noopener noreferrer" target="_blank" className="btn btn-lg black">Hire Me on Codeable</a>
                            </div>
                        </div>
                    </div>
                </div>
